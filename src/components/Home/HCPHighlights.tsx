		...
		<section className="relative bg-white">
			<div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
				...
				<div className="mt-10 grid gap-6 sm:grid-cols-2 lg:mt-14 lg:grid-cols-4">
					{items.map((item, i) => (
						<motion.div
							...
							<div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#045e5a]/10 ring-1 ring-[#045e5a]/10">
								{item.icon}
							</div>
							...
							<div className="absolute inset-x-0 bottom-0 h-0.5 scale-x-0 bg-[#045e5a] transition group-hover:scale-x-100" />
						</motion.div>
					))}
				</div>
				...
				<div className="mt-12 flex flex-col items-center justify-center gap-3 sm:flex-row">
					<Link
						href="/hcp"
						className="inline-flex items-center justify-center rounded-lg bg-[#045e5a] px-5 py-3 text-sm font-semibold text-white shadow-sm hover:bg-[#045e5a]/90">
						Explore HCP Details
					</Link>
					<Link
						href="/join"
